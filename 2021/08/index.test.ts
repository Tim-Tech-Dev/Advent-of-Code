...
describe("[2021-08]", () => {
    it("stage 0: There are 26 1, 4, 7, or 8 as digits in the output values", () => {
        const res = stage0(input);
        expect(res).to.equal(26);
    });

    it("stage 1: The sum of the decoded four-digit output values should be 61229", () => {
        const res = stage1(input);
        expect(res).to.equal(61229);
    });
});
